    ...
    public function check_if_promotions_is_active()
    {
        if (
            ...
            new PersistentAdminNotice(
                ...
                esc_html__('The "Event Espresso - Promotions Restrict to Email" plugin has been deactivated automatically because the required "Event Espresso - Promotions" was not activated.', 'eea-promotions-restrict-to-email'),
                true
            );
            //phpcs:enable
        }
