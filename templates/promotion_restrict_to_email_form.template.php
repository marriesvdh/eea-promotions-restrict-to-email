...
<table class="form-table" id="promotion-details-form-restrict-to-email">
    <tr>
        <th scope="row">
            <label for="PRX_emailrestrict"><?php esc_html_e('Restrict to email address(es)', 'event-espresso-promotions-restrict-to-email'); ?></label>
        </th>
        <td class="field-column">
            ...
            <p class="description"><?php esc_html_e('This promotion can only be used when any of the attendees use one of these e-mail addresses. Separate multiple e-mail addresses with commas.', 'event-espresso-promotions-restrict-to-email'); ?></p>
        </td>
    </tr>
</table>
